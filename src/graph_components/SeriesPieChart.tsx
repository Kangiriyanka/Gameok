...
export default function SeriesPieChartGraph({data, width, height, name_key, data_key}: GraphProps) {
        ...
        <div className= "shadow-[var(--double-shadow)] rounded-lg border border-[var(--n64-gray-clr)] w-fit relative " >
           <PieChart width={width} height={height}  data={data} margin={{
            ...
            <Pie 
              ...
              strokeWidth= {1}
            data={data} dataKey={data_key} nameKey={name_key} cx="50%" cy="45%" outerRadius={140} innerRadius={100}  paddingAngle={5}  >
