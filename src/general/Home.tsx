   ...
   <div className="flex">
      ...
      <div className="page-header">
        ...
        <div className=" flex gap-10 stats-container w-[50%] ">
         <div className="bg-[var(--n64-dark-gray-clr)] shadow-[var(--card-shadow)]  rounded-[0.5rem] border-2 border-[var(--n64-gray-clr)] p-4 relative top-8 game-stats p-10 w-[50%] h-fit">
          <div className="flex flex-col justify-center  text-center">
            <span className="text-2xl text-[var(--n64-b-clr)]  font-medium ">Consoles</span>
            <span className="text-xl ">{stats[1]}</span>
          </div>
        </div>
        <div className="bg-[var(--n64-dark-gray-clr)]  shadow-[var(--card-shadow)] rounded-[0.5rem] border-2 border-[var(--n64-gray-clr)] p-4 relative top-8 game-stats p-10 w-[50%]">
          <div className="flex flex-col justify-center text-center">
